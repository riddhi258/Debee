     ...
     <footer className='bg-[#F7F7F7] pt-6 px-6 md:px-16'>
          <div className="flex flex-wrap md:flex-row flex-col gap-4 justify-between">
            <div className="box1">
              ...
              <p className='pt-6 mb-4'>7310 Fieldstone Lane<br /> Brooklyn,NY 1120</p>
             
              <p className='font-semibold text-black hover:text-red-500 cursor-pointer transform transition-transform duration-300 hover:scale-110'>(708)638-5584</p>
